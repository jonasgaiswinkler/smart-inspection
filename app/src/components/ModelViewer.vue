...
export default defineComponent({
  ...
  mounted() {
    ...
    const model = stlLoader.load({
        id: "myModel",
        src: "https://firebasestorage.googleapis.com/v0/b/smart-inspection-fhstp.appspot.com/o/Bridge%20N091013.stl?alt=media&token=1db1f730-48f1-4c57-ad57-3a8fa1b7d593",
        smoothNormals: true,
        rotate: [90, 0, 0],
    });
